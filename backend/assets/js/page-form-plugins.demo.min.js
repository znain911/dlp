...
var handleDatepicker = function() {
    ...
    handleDateRangePicker = function() {
		...
		$(".daterange-singledate").daterangepicker({
            ...
            var t = moment().diff(e, "years");
        })
		$(".daterange-singledate-from").daterangepicker({
            singleDatePicker: !0,
            showDropdowns: !0,
			autoUpdateInput: false,
        }, function(e) {
            var t = moment().diff(e, "years");
			$('.daterange-singledate-from').val(e.format('YYYY-MM-DD'));
        })
		$(".daterange-singledate-to").daterangepicker({
            singleDatePicker: !0,
            showDropdowns: !0,
			autoUpdateInput: false,
        }, function(e) {
            var t = moment().diff(e, "years");
			$('.daterange-singledate-to').val(e.format('YYYY-MM-DD'));
        })
    },
