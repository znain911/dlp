...
public function rtc()
	...
	public function batch_create()
	{
		...
		$data = array(
					...
					'number_of_students'    => $this->input->post('studentno'),
		...
		$validate = array(
						array(
							'field' => 'batch_name', 
							'label' => 'RTC Name', 
							'rules' => 'required|trim|is_unique[starter_batch.batch_name]', 
						),
					);
		$this->form_validation->set_rules($validate);
		if($this->form_validation->run() == true)
	...
	public function rtc_student_view()
	{
		$student_id = $this->input->post('student_id');
		$data['item'] = $this->Batch_model->get_students($student_id);
		/*print_r($data['item']);exit;*/
		$content = $this->load->view('setup/batch/batch_students', $data, true);
		$result = array('status' => 'ok', 'content' => $content);
		$result[$this->sqtoken] = $this->sqtoken_hash;
		echo json_encode($result);
		exit;
...
public function batch_teacher($id)
	...
	public function batch_teacher_create()
	{
		...
		$btchid = $this->input->post('batch_ognl');
		...
		$data = array(
					...
					'teacher_batch'    => $this->input->post('batch_ognl'),
...
public function events()
	{
		$this->load->view('setup/events/index2');
	}
	...
	public function events_create()
	{
		...
		if($this->form_validation->run() == true)
		{
			...
			$data_template['display_content'] = TRUE;
			$content = $this->load->view('setup/events/event_list', $data_template, true);
			$success = '<div class="alert alert-success">successfully created!</div>';
			$result = array('status' => 'ok', 'success' => $success, 'content' => $content);
			$result[$this->sqtoken] = $this->sqtoken_hash;
			echo json_encode($result);
	...
	public function events_create_item()
	{
		$data['display'] = TRUE;
		$data['phase_id'] = $this->input->post('phase_id');
		$content = $this->load->view('setup/events/create_form', $data, true);
		$result = array('status' => 'ok', 'content' => $content);
		$result[$this->sqtoken] = $this->sqtoken_hash;
		echo json_encode($result);
		exit;
	...
	{
		$data['id'] = $this->input->post('id');
		$content = $this->load->view('setup/events/edit_form', $data, true);
		$result = array('status' => 'ok', 'content' => $content);
		$result[$this->sqtoken] = $this->sqtoken_hash;
		echo json_encode($result);
		exit;
...
public function zoomlink()
	{
		$this->load->view('setup/zoom/index2');
	}
	...
	public function zoom_create()
	{
		$this->load->library('form_validation');
		$data = array(
					'zoom_title'    => $this->input->post('title'),
					'button_title'    => $this->input->post('button_title'),
					'zoom_rtl'    => $this->input->post('type'),
					'zoom_link'      => $this->input->post('details'),
					'zoom_date'      => $this->input->post('event_date'),
					'status'      => $this->input->post('status'),
					'added_by'      => $this->session->userdata('active_user'),  
				);
		$validate = array(
		...
		{
			//save
			$this->Zoom_model->create($data);
			$data_template['display_content'] = TRUE;
			$content = $this->load->view('setup/zoom/event_list', $data_template, true);
			$success = '<div class="alert alert-success">successfully created!</div>';
			$result = array('status' => 'ok', 'success' => $success, 'content' => $content);
			$result[$this->sqtoken] = $this->sqtoken_hash;
			echo json_encode($result);
	...
	public function zoom_create_item()
	{
		$data['display'] = TRUE;
		$data['phase_id'] = $this->input->post('phase_id');
		$content = $this->load->view('setup/zoom/create_form', $data, true);
		$result = array('status' => 'ok', 'content' => $content);
		$result[$this->sqtoken] = $this->sqtoken_hash;
		echo json_encode($result);
		exit;
	...
	{
		$data['id'] = $this->input->post('id');
		$content = $this->load->view('setup/zoom/edit_form', $data, true);
		$result = array('status' => 'ok', 'content' => $content);
		$result[$this->sqtoken] = $this->sqtoken_hash;
		echo json_encode($result);
		exit;
	...
	public function zoom_update()
	{
		...
		{
			//save
			$this->Zoom_model->update($id, $data);
			$data_template['display_content'] = TRUE;
			$content = $this->load->view('setup/zoom/event_list', $data_template, true);
			$success = '<div class="alert alert-success">successfully updated!</div>';
			$result = array('status' => 'ok', 'success' => $success, 'content' => $content);
	...
	public function zoom_delete()
	{
		$id = $this->input->post('id');
		
		//Delete coordinator
		$this->db->where('id', $id);
		$this->db->delete('starter_zoom_link');
...
public function carryzoomlink()
	{
		$this->load->view('setup/zoomcarryon/index2');
	}
	
	public function carryzoom_create()
	{
		$this->load->library('form_validation');
		$data = array(
					'zoom_title'    => $this->input->post('title'),
					...
					'class_type'      => 1,
					'zoom_date'      => $this->input->post('event_date'),
					'zoom_time'      => $this->input->post('zoom_time'),
					'status'      => $this->input->post('status'),
					'added_by'      => $this->session->userdata('active_user'),  
				);
		$validate = array(
		...
		if($this->form_validation->run() == true)
		{
			...
			$this->Zoom_model->create($data);
			$data_template['display_content'] = TRUE;
			$content = $this->load->view('setup/zoomcarryon/event_list', $data_template, true);
			$success = '<div class="alert alert-success">successfully created!</div>';
			$result = array('status' => 'ok', 'success' => $success, 'content' => $content);
			$result[$this->sqtoken] = $this->sqtoken_hash;
			echo json_encode($result);
	...
	public function carryzoom_create_item()
	{
		$data['display'] = TRUE;
		$data['phase_id'] = $this->input->post('phase_id');
		$content = $this->load->view('setup/zoomcarryon/create_form', $data, true);
		$result = array('status' => 'ok', 'content' => $content);
		$result[$this->sqtoken] = $this->sqtoken_hash;
		echo json_encode($result);
		exit;
	...
	public function carryzoom_edit()
	{
		$data['id'] = $this->input->post('id');
		$content = $this->load->view('setup/zoomcarryon/edit_form', $data, true);
		$result = array('status' => 'ok', 'content' => $content);
		$result[$this->sqtoken] = $this->sqtoken_hash;
		echo json_encode($result);
		exit;
	...
	public function carryzoom_update()
	{
		$this->load->library('form_validation');
		$id = $this->input->post('id');
		$data = array(
	...
	public function carryzoom_delete()
	{
		$id = $this->input->post('id');
