...
<body class="main-body">
	<div class="mail-container-bdy">
		...
		<p>Congratulations you have successfully enrolled for the CCD Course. Please click on the login below to login to the course: 
			<br /> Click the URL : <?php echo urlencode(base_url('student/login')); ?>
		</p>
		<p>
			<strong>Email :</strong> <?php echo $get_studentinfo['student_email']; ?><br />
			<strong>Password :</strong> <?php echo $get_studentinfo['student_gtp']; ?>
		</p>
