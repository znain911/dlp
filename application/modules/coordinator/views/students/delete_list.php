<?php require_once APPPATH.'modules/coordinator/templates/header.php'; ?>
									...
									<tbody>
										...
										<tr class="items-row-<?php echo $item['student_id']; ?>">
											...
											<td class="text-center">
												...
												<button data-student="<?php echo $item['student_id']; ?>" class="remove-row btn btn-danger btn-xs p-l-10 p-r-10"><i class="fa fa-times"></i> Delete</button>
		...
		<script type="text/javascript">
			...
			function searchFilter(page_num) {
				...
				$.ajax({
					type: 'POST',
					url: '<?php echo base_url(); ?>studentfilter/get_wantdelete_student/'+page_num,
