<?php require_once APPPATH.'modules/coordinator/templates/header.php'; ?>
		...
		<div id="content" class="content">
			...
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h2 class="page-header">Total Enrolled Students : <span id="totalEnrolledStudents"><?php echo count($get_total) ?></span> | Total Active Batch : <span id="totalEnrolledStudents"><?php echo count($betchlist) ?></span></h2>
