...
<!-- <button type="button" class="btn btn-warning">Warning</button> -->
			...
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h2 class="page-header">Total : <span id="totalEnrolledStudents"><?php echo count($get_total) ?></span> | Total Active Batch : <span id="totalEnrolledStudents"><?php echo count($betchlist) ?></span></h2>
