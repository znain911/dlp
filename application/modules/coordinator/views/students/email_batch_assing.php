...
<body class="main-body">
	<div class="mail-container-bdy">
		...
		<p>Welcome to <?php echo $batchname;?> of CCD Batch-38. Please login to student dashboard from www.dlpbadas-bd.org -> Login -> Student using the Email (used during registration) & Password-123456. You can start your self-study after logging in.</p>		
