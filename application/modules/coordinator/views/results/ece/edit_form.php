<?php 
	$row_info = $this->Eceresults_model->get_info($id);
?>
<div class="form-cntnt form-number-<?php echo $id; ?>">
	...
	?>
		...
		<div class="form-group">
			...
			<div class="col-md-4">
				<select class="form-control" disabled>
					<?php 
						$sid = $this->Eceresults_model->get_student_info($row_info['cpreport_student_id']);
					...
					?>
					<option value="<?php echo $sid['student_id']; ?>" selected="selected"><?php echo $full_name.' ('.$sid['student_entryid'].')'; ?></option>
				</select>
		...
		<div>
			<?php 
				$get_marks = $this->Eceresults_model->get_marksby_progress($row_info['cpreport_id']);
