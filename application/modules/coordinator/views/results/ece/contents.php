...
<div id="onPgaeLoadingForm">
	<?php require_once APPPATH.'modules/coordinator/views/results/ece/create_form.php'; ?>
</div>
		...
		<div id="getContents">
			<table id="data-table" class="table table-td-valign-middle m-b-0">
				...
				<tbody class="appnd-not-fnd-row">
					<?php
					$get_items = $this->Eceresults_model->get_all_items();
						foreach($get_items as $item):
						$total_marks = $this->Eceresults_model->count_total_marks($item['cpreport_id']);
					?>
