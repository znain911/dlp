<?php 
	$schedule_info = $this->Eceschedule_model->get_centerschedule_info($schedule_id);
?>
<div class="form-cntnt lesson-form-number-<?php echo $schedule_id; ?>">
	...
	?>
		...
		<div class="form-group">
			...
			<div class="col-md-4">
				<input type="text" class="form-control" value="<?php echo $this->Eceschedule_model->get_schedule_title($schedule_info['centerschdl_parentschdl_id']); ?>" disabled />
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-md-4">
				<select name="center_id" class="form-control">
					...
					<?php 
						$center_lists = $this->Eceschedule_model->get_center_lists();
		...
		<div class="form-group">
			...
			<div class="col-md-4">
				...
				<span style="color: #f00;display: block;font-size: 12px;">Note : Please select date within <?php echo booking_schedule_range($schedule_id, 'ECE'); ?></span>
			</div>
		</div>
