<?php 
	$schedule_info = $this->Schedules_model->get_schedule_info($schedule_id);
?>
<div class="form-cntnt module-form-number-<?php echo $schedule_id; ?>">
	<h2 class="frm-title-ms">Edit Schedule</h2>
	<?php 
		$attr = array('class' => 'form-horizontal', 'id' => 'upMdlSchedule');
	...
	?>
		...
		<div class="form-group">
			<label class="col-md-8 control-label">Exam Title</label>
			<div class="col-md-4">
				<input type="text" name="exam_title" placeholder="Enter Exam Title" class="form-control" value="<?php echo $schedule_info['endmschedule_title']; ?>">
			</div>
		</div>
		<div class="form-group">
