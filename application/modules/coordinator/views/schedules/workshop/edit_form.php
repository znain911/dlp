	...
	?>
		...
		<div class="form-group">
			...
			<div class="col-md-4">
				...
				<div style="margin-bottom:10px;">
					<a style="background: pink;color: #333;font-size: 12px;display: inline-block;padding: 3px 5px;text-decoration: none;" href="<?php echo attachment_url('resources/workshop/'.$schedule_info['endmschedule_student_resource']); ?>">View Resource</a>
		...
		<div class="form-group">
			...
			<div class="col-md-4">
				...
				<div style="margin-bottom:10px;">
					<a style="background: pink;color: #333;font-size: 12px;display: inline-block;padding: 3px 5px;text-decoration: none;" href="<?php echo attachment_url('resources/workshop/'.$schedule_info['endmschedule_faculty_resource']); ?>">View Resource</a>
