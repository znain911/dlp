<?php require_once APPPATH.'modules/coordinator/templates/header.php'; ?>
		...
		<div id="content" class="content">
			...
			<ol class="breadcrumb pull-right">
				...
				<li><a href="<?php echo base_url('coordinator/setup/rtc'); ?>">RTC</a></li>
				<li><a href="javascript:;">Assign Faculty</a></li>
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header"><a href="<?php echo base_url('coordinator/setup/rtc'); ?>">RTC</a> -> <?php echo $batchinfo->batch_name;?> | Bantch -> <?php echo $batchinfo->batch;?></h1>
			<!-- end page-header -->
