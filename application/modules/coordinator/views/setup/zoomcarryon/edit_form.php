...
<div class="form-cntnt form-number-<?php echo $id; ?>">
	...
	?>
		...
		<div class="form-group">
			...
			<div class="col-md-6">
				<input type="text" name="details" placeholder="Zoom Link" class="form-control" value="<?php echo $row_info['zoom_link'];?>" required>
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-md-6">
				<textarea name="student_list" class="form-control" cols="30" rows="12" required><?php echo $row_info['student_list'];?></textarea>
			</div>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<div class="col-md-4">
				<input type="text" name="zoom_time" class="custominp datetimepicker2 valid" placeholder="Time" value="<?php echo $row_info['zoom_time'];?>">
			</div>
		</div>
		<div class="form-group">
