...
<div id="onPgaeLoadingForm">
	<?php require_once APPPATH.'modules/coordinator/views/setup/coordinators/create_form.php'; ?>
</div>
	...
	<div class="table-responsive">
		<div id="getContents">
			<table id="data-table" class="table table-td-valign-middle m-b-0">
				...
				<tbody>
					<?php 
						$get_items = $this->Coordinator_model->get_all_items();
					...
					<tr class="cnt-row items-row-<?php echo $item['owner_id']; ?>">
						...
						<td class="text-center">
							<a style="margin-bottom: 5px; display: inline; width: auto; padding: 3px 0px;" href="#modal-without-animation" data-id="<?php echo $item['owner_id']; ?>" class="row-action-change-password btn btn-block btn-success btn-xs p-l-10 p-r-10" data-toggle="modal">Change Password</a>
