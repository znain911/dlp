			...
			<div class="row">
				...
				<div class="col-md-12 mostak-mdl-box">
					...
					<div id="moduleLessonDisplay">
						<?php require_once APPPATH.'modules/coordinator/views/setup/coordinators/edit_profile.php'; ?>
					</div>
				</div>
				<!-- end col-4 -->
			</div>
		...
		<script type="text/javascript">
			$("#updateData").validate({
				...
				submitHandler : function () {
					...
					$.ajax({
						type : "POST",
						url : baseUrl + "coordinator/profile/coordinators_update",
						data : getFrmData,
						dataType : "json",
						cache: false,
						contentType: false,
			...
			$(document).ready(function(){
				...
				$("#upPassrf").validate({
					...
					submitHandler : function () {
						...
						$.ajax({
							type : "POST",
							url : baseUrl + "coordinator/profile/coordinators_change_password",
							data : getFrmData,
							dataType : "json",
							cache: false,
							contentType: false,
