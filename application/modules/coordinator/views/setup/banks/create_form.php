<div class="form-cntnt" style="display:none">
	...
	?>
		...
		<div class="form-group">
			...
			<div class="col-md-4">
				<input type="text" name="bank_branch_name" placeholder="Enter Branch Name" class="form-control">
			</div>
		</div>
		<div class="form-group">
			<label class="col-md-8 control-label">Account Name</label>
			<div class="col-md-4">
				<input type="text" name="bank_account_name" placeholder="Enter Account Name" class="form-control">
			</div>
		</div>
		<div class="form-group">
