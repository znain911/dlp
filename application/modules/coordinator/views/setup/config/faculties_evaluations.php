<?php require_once APPPATH.'modules/coordinator/templates/header.php'; ?>
		...
		<div id="content" class="content">
			...
			<ol class="breadcrumb pull-right">
				...
				<li><a href="javascript:;">Faculties Evaluations Settings</a></li>
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Faculties Evaluations Settings</h1>
			<!-- end page-header -->
				...
				<div class="col-md-12 mostak-mdl-box">
					...
					<div id="moduleLessonDisplay">
						<div class="form-cntnt">
							<h2 class="frm-title-ms">Faculties Evaluations Settings</h2>
							<?php 
							...
							?>
								...
								<div id="marksDistribute">
									<?php 
										$get_labels = $this->Setup_model->get_all_faculties_labels();
										$ev_count = 1;
		...
		<script type="text/javascript">
			$("#configData").validate({
				submitHandler : function () {
					...
					$.ajax({
						type : "POST",
						url : baseUrl + "coordinator/setup/update_faculties_evaluations",
