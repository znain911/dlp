<?php 
	$row_info = $this->Specialization_model->get_info($id);
?>
<div class="form-cntnt form-number-<?php echo $id; ?>">
	...
	?>
		...
		<div class="form-group">
			<label class="col-md-8 control-label">Specialization Title</label>
			<div class="col-md-4">
				<input type="text" name="title" placeholder="Enter Specialization Title" class="form-control" value="<?php echo $row_info['specialize_name']; ?>">
			</div>
		</div>
		<div class="form-group">
			<label class="col-md-8 control-label">Status</label>
			<div class="col-md-4 control-label">
				<label><input type="radio" name="status" value="1" <?php echo ($row_info['specialize_status'] === '1')? 'checked' : null; ?> />&nbsp;&nbsp;Active</label>&nbsp;&nbsp;&nbsp;&nbsp;<label><input type="radio" name="status" value="0" <?php echo ($row_info['specialize_status'] === '0')? 'checked' : null; ?> />&nbsp;&nbsp;Inactive</label>
			</div>
		</div>
