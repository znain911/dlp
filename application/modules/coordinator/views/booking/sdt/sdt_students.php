<?php require_once APPPATH.'modules/coordinator/templates/header.php'; ?>
		<!-- end #header -->
		<?php $get_applicants = $this->Booking_model->get_sdt_applicants('Student', $sdt_type); ?>
		<!-- begin #sidebar -->
		...
		<div id="content" class="content">
			...
			<ol class="breadcrumb pull-right">
				...
				<li><a href="javascript:;">SDT <?php echo $sdt_type; ?> Applicants (Students)</a></li>
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">SDT <?php echo $sdt_type; ?> Applicants (Students) : <span id="totalSdtBooking"><?php echo count($get_applicants) ?></span></h1>
			<!-- end page-header -->
