<?php require_once APPPATH.'modules/coordinator/templates/header.php'; ?>
		...
		<div id="content" class="content">
			...
			<ol class="breadcrumb pull-right">
				...
				<li><a href="javascript:;">Phase Exam Applicants (Faculties)</a></li>
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Phase Exam Applicants (Faculties)</h1>
			<!-- end page-header -->
							...
							<div id="postList">
								<table id="data-table" class="table table-td-valign-middle m-b-0">
									...
									<tbody class="appnd-not-fnd-row">
										<?php 
											$sl = 1;
											$get_applicants = $this->Booking_model->get_phase_applicants('Faculty');
			...
			$(document).ready(function(){
				...
				$(document).on('click', '.remove-row', function(){
					if(confirm('Are you sure?', true))
					{
						...
						$.ajax({
							type: 'POST',
							url: baseUrl+'coordinator/booking/phase_delete',
