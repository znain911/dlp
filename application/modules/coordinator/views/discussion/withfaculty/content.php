<?php 
	$messages = $this->Discussion_with_faculty_model->get_reply_by_discussion($discuss_id);
	foreach($messages as $message):
?>
	<?php if($message['reply_user_type'] == 'FACULTY'): ?>
	<?php 
		$teacher_photo = $this->Discussion_with_faculty_model->get_teacher_photo($message['reply_answered_by']);
	...
	<?php 
		$student_photo = $this->Discussion_with_faculty_model->get_student_photo($message['reply_answered_by']);
