	...
	<tbody>
		...
		<tr class="items-row-<?php echo $item['student_id']; ?>">
			...
			<td class="text-center">
				...
				<!-- <button data-student="<?php echo $item['student_id']; ?>" onclick="return confirm('Are you sure?', true);" class="remove-row btn btn-danger btn-xs btn-rounded p-l-10 p-r-10"><i class="fa fa-times"></i> Reject</button> -->
				<button data-target="#reject-modal" data-toggle="modal" data-student="<?php echo $item['student_id']; ?>" data-status="5" class="row-action-rjct btn btn-danger btn-xs p-l-10 p-r-10"><i class="fa fa-trash"></i> Rejects</button>
			</td>
		</tr>
		<?php endforeach; ?>
		<?php else: ?>
