	...
	<tbody>
		...
		<tr class="items-row-<?php echo $item['discuss_id']; ?>">
			...
			<td class="text-center">
				<button data-target="#modal-without-animation" data-toggle="modal" data-id="<?php echo $item['discuss_id']; ?>" class="row-action-view btn btn-default btn-xs p-l-10 p-r-10"><i class="fa fa-eye"></i> View</button>
