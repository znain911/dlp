<?php 
	...
	$get_sessions = $this->Perm_model->get_sdt_schedules($this->session->userdata('active_phase'), $sdt_type);
	
	//check booked
	$get_booked_schedules = $this->Perm_model->get_sdt_booked($sdt_type);
	$get_schedules = array();
