<?php require_once APPPATH.'modules/common/header.php'; ?>
			...
			<div class="col-lg-9">
				<div class="edit-info-cntr">
					<div class="result-table">
						...
						<?php  
							$attr = array('id' => 'updateStudentPersonalinfo', 'class' => 'position-relative');
							echo form_open_multipart('', $attr);
							$personal_info = $this->Student_model->get_personal_info();
						?>
							...
							<div class="row reg-flow-input-mrg">
								...
								<div class="col-lg-4 form-group sel-dropdown-mrgn">
									...
									<select class="spoecial-aff-mostak" name="nationality">
										<?php 
											$get_countries = $this->Student_model->get_all_countries();
								...
								<div class="col-lg-4">
									...
									<div class="form-group">
										<?php if($personal_info['spinfo_photo']): ?>
										  <div class="old-img"><img src="<?php echo attachment_url('students/'.$personal_info['student_entryid'].'/'.$personal_info['spinfo_photo']); ?>" style="height:50px;width:65px" alt="Recent Photo" /></div>
										<?php endif; ?>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			//start step 2
			$("#updateStudentPersonalinfo").validate({
				rules:{
					first_name:{
						required: true,
					},
				...
				submitHandler : function () {
					$('#proccessLoader').show();
					var personalFormData = new FormData(document.getElementById('updateStudentPersonalinfo'));    
					$.ajax({
						type : "POST",
						url : baseUrl + "student/update_personal_info",
						...
						success : function (data) {
							if(data.status == 'ok')
							{
								...
								if(data.personal_phone_changed !== '')
								{
									$('#alert').append(data.personal_phone_changed);
								}
								$('html, body').animate({
