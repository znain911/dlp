    ...
    <body>
        ...
        <div class="main-header">
			<div class="col-lg-12 text-center">
				...
				<img src="<?php echo base_url('frontend/assets/img/lesson-header.png');?>" style="height:auto; width:2000px">
				
					<h2 style="font-size:19px;font-weight:bold;">L <?php echo $lesson_info['lesson_position']; ?> | <?php echo $lesson_info['lesson_title']; ?></h2>
			</div>
		</div>
		<div class="main-body" style="color: #000000;">
			<div class="col-lg-12">
