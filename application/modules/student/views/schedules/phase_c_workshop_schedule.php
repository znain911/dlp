<?php 
	$check_sdt_schedule = $this->Course_model->workshop_available_schedule($phase_lavel);
?>
<div class="row">
	<div class="col-lg-6">
	...
	<div class="col-lg-6">
		<div class="end-module-exam">
			...
			<div class="starter-module-exam-start">
				<div class="endmodule-exm-title">Workshop</div>
				<h2>The Workshop will be available after scheduled by Coordinator</h2>
				<?php 
					$check_sdtalr_booked = $this->Course_model->check_workshop_alrbooked(date("Y-m-d", strtotime($check_sdt_schedule['endmschedule_create_date'])), $check_sdt_schedule['endmschedule_to_date'], $phase_lavel);
					if($check_sdtalr_booked == true):
					$get_center_details = $this->Course_model->get_workshopcenter_location($check_sdtalr_booked['booking_schedule_centerid']);
				?>
			...
			<div class="end-module-exam booking-frm-sdt" style="display:none;">
				<div class="starter-module-exam-start">
					...
					<?php 
						...
						echo form_open('', $attr);
						$get_application_id = $this->Course_model->get_total_workshopapplications();
					?>
					...
					<div class="form-group row">
						...
						<div class="col-lg-10">
							<select name="center" class="form-control">
								...
								<?php  
									$get_centerschedules = $this->Course_model->get_workshop_centerschedules($check_sdt_schedule['endmschedule_id']);
