				...
				<div class="col-lg-9">
					<div class="f2f-booking-form myac-container">
						<div class="endmodule-exm-title">Write Evaluation Report</div>
							...
							<div class="form-group row">
								<?php $fclt = $this->Evaluation_model->rtc_faculty_info($dashboard_info['student_rtc']); ?>
								<label for="" class="col-lg-3 text-right">Faculty</label>
								<div class="col-lg-6">
									
									<input type="text" name="faculty" class="form-control" value="<?php echo $fclt->tpinfo_first_name.' '.$fclt->tpinfo_middle_name.' '.$fclt->tpinfo_last_name; ?>" placeholder="Search Faculty" readonly />
									<input type="hidden" name="faculty_id" value="<?php echo $fclt->teacher_id; ?>" />
								</div>
							</div>
