...
<div class="form-field-content">
	<div class="row reg-flow-input-mrg">
		...
		<div class="col-lg-4">
			<div class="form-group">
				<label for="">Designation <span class="mdtry">*</span></label>
	...
	<div class="row reg-flow-input-mrg">
		...
		<div class="col-lg-4 form-group">
			<label for="">BM&DC Number  <span class="mdtry">*</span></label>
			<input type="text" name="bmanddc_number" class="form-control" placeholder="Enter number here"/>
		</div>
		<div class="col-lg-4 form-group">
			<label for="">BMDC Certificate <span class="mdtry">*</span></label>
			<!-- <input type="text" name="bmanddc_number" class="form-control" placeholder="Enter number here"/> -->
			<div class="form-group">
						...
						<p style="font-size: 12px;">JPG, PNG and PDF Only.</p>
					</div>
		</div>
	</div>
	<div class="row reg-flow-input-mrg">
		<div class="col-lg-15"><label for="">Degree <span class="mdtry">*</span></label></div>
		<div class="col-lg-15"><label for="">Year <span class="mdtry">*</span></label></div>
		<div class="col-lg-15"><label for="">Institue/University <span class="mdtry">*</span></label></div>
		<div class="col-lg-15"><label for="">Marks/CGPA <span class="mdtry">*</span></label></div>
		<div class="col-lg-15"><label for="">Certificate <span class="mdtry">*</span></label></div>
	</div>
	<div class="multiple-result-entry">
		<div id="academicresultFlow">
			...
			<div class="row reg-flow-input-mrg">
				<div class="col-lg-15"><div class="form-group"><input type="text" name="degree_2" class="form-control" placeholder="MBBS" /></div></div>
	...
	<div class="row reg-flow-input-mrg">
		...
		<div class="col-lg-12">
			<h4>I have gone through the Terms and Conditions (in the website) that apply for CCD students. I shall abide by them and I also agree that:</h4>
			<div class="form-control" style="background:none !important;">
			    <label for="step3tc1" style="float:right; font-size: 15px; text-align:left; padding-left: 10px; width:95%;"><strong>1)	Approval authority will decline my application if my Permanent BMDC Registration is not uploaded correctly and/or does not match with that of BMDC website.</strong></label>
			    <input  type="checkbox" class="" value="1" name="step3tc1" id="step3tc1" style="float:right; height: 20px; width: 20px;" >
			</div>
			<div style="height: 17px; clear:both;"></div>
			<div class="form-control" style="background:none !important;">
			    <label for="step3tc2" style="float:right; font-size: 15px; text-align:left; padding-left: 10px; width:95%;"><strong>2)	During the course I have to complete my self-study (Lessons and End Lesson Practices) of all the Modules of each Phase prior to seat for PCA (Phase Completion Assessment) – if not done I will be considered not eligible to attend PCA.</strong></label>
			    <input  type="checkbox" class="" value="1" name="step3tc2" id="step3tc2" style="float:right; height: 20px; width: 20px;" >			    
			</div>
			<div style="height: 17px; clear:both;"></div>
			<div class="form-control" style="background:none !important;">
				<label for="step3tc3" style="float:right; font-size: 15px; text-align:left; padding-left: 10px; width:95%;"><strong>3)	During End Course Examination (ECE) I will have to keep camera of my device open. Therefore I will have to use device that is compatible; otherwise system will reject me as a candidate of ECE.</strong></label>
			    <input  type="checkbox" class="" value="1" name="step3tc3" id="step3tc3" style="float:right; height: 20px; width: 20px;" >
