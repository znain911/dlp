					...
					<div class="result-table">
						...
						<table class="table">
							...
							<tbody id="sessionContent">
								<?php require_once APPPATH.'modules/student/views/session/all_sessions.php' ?>
							</tbody>
						</table>
					</div>
				</div>
					...
					<div class="result-table">
						...
						<table class="table">
							...
							<tbody id="bookingContent">
								<?php require_once APPPATH.'modules/student/views/session/all_bookings.php' ?>
							</tbody>
						</table>
					</div>
				</div>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			$(document).on('click', '.session-row', function(){
				...
				$.ajax({
					type : "POST",
					url : baseUrl + "student/booking/ftwof_frmsubmission",
						...
						if(data.status == "ok")
						{
							...
							$("#ftwofBooking").validate({
								...
								submitHandler : function () {
									...
									$.ajax({
										type : "POST",
										url : baseUrl + "student/booking/ftwof",
