					...
					<div class="result-table">
						...
						<table class="table" style="font-size:12px;">
							...
							<tbody id="sessionContent">
								<?php require_once APPPATH.'modules/student/views/workshop/all_sessions.php' ?>
							</tbody>
						</table>
					</div>
					...
					<div class="result-table">
						...
						<table class="table" style="font-size:12px;">
							...
							<tbody id="bookingContent">
								<?php require_once APPPATH.'modules/student/views/workshop/all_bookings.php' ?>
							</tbody>
						</table>
					</div>
				</div>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			$(document).on('click', '.session-row', function(){
				...
				$.ajax({
					type : "POST",
					url : baseUrl + "student/booking/workshop_frmsubmission",
