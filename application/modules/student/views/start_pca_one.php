			...
			<div class="container">
				<div class="col-lg-12">
					<div class="content-text-goes">
						<h4 class="cnt-title">
							Notice for PCA 1 Exams
						</h4>
						<p class="cnt-para">
							<strong>IT IS IMPORTANT TO READ THE NOTICE BEFORE YOU PRESS “START”</strong> <br /><br />
							The <strong>PCA-1 EXAM</strong> is an <strong>ONLINE BASED EXAM</strong> that is <strong>TIME RESTRICTED</strong>. The <strong>TIME</strong> can be seen on the <strong>TOP RIGHT-HAND SIDE</strong> of the screen. Once you press Start, the countdown shall begin. You can end the exam if you press Submit. If the Time elapses before you Submit, then the Online PCA-1 Exam shall end automatically.
							<br /><br />
							The Online PCA-1 Exam is expected to test your knowledge on the content you have learned through Phase A. 
							<br /><br />
							You are required to pass the pass the Online PCA-1 Exam, to proceed to Phase B.
							<br /><br />
							If you fail to pass on the first attempt, you shall have the opportunity to redo the Online PCA-1 Exam. 
							If you are required to <strong>redo</strong> the <strong>Online PCA-1 Exam</strong>, the <strong>questions shall change</strong>.
							<br /><br />
							At the end of PCA-1, you shall be provided your result online with a review of the number of correct and incorrect answers. The results of the PCA-1 Exam shall be sent by Email and SMS.
							<br /><br />
							You can also view the result of PCA-1 Exam from the <strong>Result</strong> section in the <strong>Menu</strong>.
							<br /><br />
							If for any reason you there is power outage or loss of internet coverage, then you shall be required to redo the PCA-1 Exam.
							<br />
							Good Luck!
						</p>
