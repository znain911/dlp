...
class Discussion_model extends CI_Model {
	...
	public function get_faculties_by_search($q)
	{
		$query = $this->db->query("SELECT * FROM starter_teachers
								   LEFT JOIN starter_teachers_personalinfo ON
								   starter_teachers_personalinfo.tpinfo_teacher_id=starter_teachers.teacher_id
								   
								   WHERE (starter_teachers_personalinfo.tpinfo_first_name LIKE '%$q%' 
										OR starter_teachers_personalinfo.tpinfo_middle_name LIKE '%$q%' 
										OR starter_teachers_personalinfo.tpinfo_last_name LIKE '%$q%')
