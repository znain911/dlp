<?php require_once APPPATH.'modules/common/header.php'; ?>
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				<div class="registration-container reg-faculty" id="regContainer">
					<div id="stepWizard">
						<div class="ste-wizard-flow">
							<div class="step-absolute-container">
								...
								<div class="single-step-flow four <?php echo ($template == 'aproval')? 'active' : null; ?>">
									<div class="bullet-check-mark"><i class="zmdi zmdi-circle"></i></div>
									<div class="step-name-intext">
					...
					<div class="form-field-description" id="formDescField">
						<?php require_once APPPATH.'modules/faculty/views/regflow/'.$template.'.php'; ?>
					</div>
				</div>
			</div>
		</div>
