		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-purple">
					<h4 style="float: left;">
						Name: <strong><?php echo $stdinfo->spinfo_first_name.' '.$stdinfo->spinfo_middle_name.' '.$stdinfo->spinfo_last_name;?></strong>, 
						ID: <strong><?php echo $stdinfo->student_finalid;?></strong>
					</h4>
					<a href="<?php echo base_url('faculty/dashboard/sthistry/'.$studentid); ?>" class="btn btn-info"style="float: right; color: #fff; background: green;">View Details</a>
						...
						<table class="table table-bordered">
							...
							<tbody>								
								...
								<tr>
									...
									<td class="text-center">
						        		...
						        		foreach ($ttlph1mdl as $ph1mdl) {
											...
											/*echo $str;*/
						        			echo 'M'.$str.' - '.count($this->Dashboard_model->get_readedlessonbymodule($studentid,1,$ph1mdl->module_id)).' Out of '.count($this->Dashboard_model->get_totallesson(1,$ph1mdl->module_id)).',<br>';
						        		}
						        		?>
									</td>									
								</tr>
								<tr>
									...
									<td class="text-center">
										<?php echo count($this->Dashboard_model->get_lessonexam(1,$studentid)).' times';?>
									</td>									
								</tr>
								<tr>
									<td class="text-right">PCA-A Status</td>
									<td class="text-center">
										<?php $ph1status = $this->Dashboard_model->get_pcaexam(1,$studentid);
										if(empty($ph1status)){
											echo 'N/A';
										}else{
									...
									<td class="text-center">
										<?php 
							        		foreach ($ttlph2mdl as $ph2mdl) {
							        			...
							        			echo 'M'.$str2.' - '.count($this->Dashboard_model->get_readedlessonbymodule($studentid,2,$ph2mdl->module_id)).' Out of '.count($this->Dashboard_model->get_totallesson(2,$ph2mdl->module_id)).',<br>';
							        		}
							        	?>
									</td>									
								</tr>
								...
								<tr>
									...
									<td class="text-center">
										<?php echo count($this->Dashboard_model->get_lessonexam(2,$studentid)).' times';?>
									</td>									
								</tr>
								<tr>
									<td class="text-right">PCA-B Status</td>
									<td class="text-center">
										<?php $ph2status = $this->Dashboard_model->get_pcaexam(2,$studentid);
										if(empty($ph2status)){
											echo 'N/A';
										}else{
									...
									<td class="text-center">
										<?php 
							        		foreach ($ttlph3mdl as $ph3mdl) {
							        			...
							        			echo 'M'.$str3.' - '.count($this->Dashboard_model->get_readedlessonbymodule($studentid,3,$ph3mdl->module_id)).' Out of '.count($this->Dashboard_model->get_totallesson(3,$ph3mdl->module_id)).',<br>';
							        		}
							        	?>
									</td>
								</tr>
								...
								<tr>
									...
									<td class="text-center">
										<?php echo count($this->Dashboard_model->get_lessonexam(3,$studentid)).' times';?>
									</td>
								</tr>
								<tr>
									<td class="text-right">PCA-C Status</td>
									<td class="text-center">
										<?php $ph3status = $this->Dashboard_model->get_pcaexam(3,$studentid);
										if(empty($ph3status)){
									echo 'N/A';
								}else{
