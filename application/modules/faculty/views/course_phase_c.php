					...
					<div class="course-content-start">
						...
						<div class="wizard-step-start-box">
							<div class="step-wzard completed">
								<a class="step-up-link" href="<?php echo base_url('faculty/dashboard/sthistry/'.$stid.'?rdr=Course&phase=PCA-1&return=true'); ?>">
					...
					<div class="module-wizard-container">
						<div class="row">
							...
							<div class="<?php echo (count($get_modules) > 3)? 'col-lg-3' : 'col-lg-4' ?>">
								<div style="cursor:pointer;" onclick="window.location.href='<?php echo base_url('faculty/dashboard/sthistry_c/'.$stid.'?rdr=Course&actmdl='.$module['module_id'].'&shw=true&phase=PCA-3&return=true'); ?>'" class="module-number-stp <?php echo $progress_class; ?>"><?php echo $module['module_name']; ?></div>
							</div>
							<?php 
								$module_x++;
								endforeach; 
	...
	<script type="text/javascript">
		function getCourseLessons(page_num) {
			...
			$.ajax({
				...
				data:'page='+page_num+'&active_module='+activeModule+'&phase=3'+'&sid='+studentid,
				dataType:'json',
				beforeSend: function () {
