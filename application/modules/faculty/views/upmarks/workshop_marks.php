						...
						<table class="table" style="font-size:12px;">
							...
							<tbody id="appliedUsersContent">
								...
								<tr>
									...
									<td class="text-center"><a style="background: black;color: #FFF;font-size: 12px;display: inline-block;padding: 3px 5px;text-decoration: none;" href="<?php echo base_url('faculty/evaluation?centerscheduleID='.$student['booking_schedule_centerid'].'&student='.$student['student_entryid'].'&RDR=WORKSHOP'); ?>">Evaluate</a></td>
								</tr>
								<?php 
									$x++;
									endforeach; 
