<?php require_once APPPATH.'modules/common/header.php'; ?>
	<div class="course-page">
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
					<h2 class="course-page-title"><?php echo $phase_title; ?> Available Schedules</h2>
					<div id="applyTiSession"></div>
					<div class="result-table">
						<div id="ftwofScheduleLoader"><img src="<?php echo base_url('frontend/exam/tools/loader.gif'); ?>" /></div>
						<p class="result-tbl-head"><strong>All Schedules</strong></p>
						<table class="table">
							<thead>
								<tr>
							...
							<tbody id="sessionContent">
								<?php require_once APPPATH.'modules/faculty/views/phase/all_sessions.php' ?>
							</tbody>
						</table>
					</div>
				</div>
			...
			<div class="row">
				<div class="col-lg-12">
					<h2 class="course-page-title">Booked <?php echo $phase_title; ?> Schedules</h2>
					<div class="result-table">
						<p class="result-tbl-head"><strong>All Booked Schedules</strong></p>
						<table class="table">
							<thead>
								<tr>
									<th class="text-left">Schedule Title</th>
							...
							<tbody id="bookingContent">
								<?php require_once APPPATH.'modules/faculty/views/phase/all_bookings.php' ?>
							</tbody>
						</table>
					</div>
				</div>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			$(document).on('click', '.session-row', function(){
				...
				$.ajax({
					type : "POST",
					url : baseUrl + "faculty/booking/phase_frmsubmission",
						...
						if(data.status == "ok")
						{
							...
							$("#ftwofBooking").validate({
								...
								submitHandler : function () {
									...
									$.ajax({
										type : "POST",
										url : baseUrl + "faculty/booking/phase",
