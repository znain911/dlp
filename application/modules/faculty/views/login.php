          ...
          <div class="col-lg-6">
            <div class="card card-hero card-primary">
              <div class="card-body student-login">
                ...
                <h1 class="color-primary text-center">Faculty Login</h1>
				<div id="alert"></div>
				<?php 
					$attr = array('class' => 'form-horizontal', 'id' => 'teacherLogin');
					echo form_open('', $attr);
				?>
                  <fieldset>
                    <div class="form-group row">
                      ...
                      <div class="col-md-9">
                        <input type="text" name="email_or_id" class="form-control" id="inputEmail" placeholder="Email Or ID"> </div>
                    </div>
                    <div class="form-group row">
                      <label for="inputPassword" class="col-md-3 control-label">Password</label>
                      <div class="col-md-9">
                        <input type="password" name="password" class="form-control" id="mainPass" placeholder="Password">
				  ...
				  <p class="p-forget-pass"><a href="<?php echo base_url('faculty/login/forget'); ?>"><strong>Forget your password?</strong></a></p>
                <?php echo form_close(); ?>
              </div>
            </div>
          </div>
