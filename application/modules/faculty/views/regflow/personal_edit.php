...
<div class="form-field-content">
	...
	<div class="row reg-flow-input-mrg">
		<div class="col-lg-4 form-group">
			...
			<input name="birthday" class="form-control" value="<?php echo $personal_info['tpinfo_birth_date']; ?>" placeholder="DD/MM/YYYY" type="text" data-inputmask-alias="datetime" data-inputmask-inputformat="dd/mm/yyyy">
		</div>
		<div class="col-lg-4">
