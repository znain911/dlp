			...
			<div class="col-lg-9">
				<div class="edit-info-cntr">
					<div class="result-table">
						...
						<?php  
							$attr = array('id' => 'updateTeacherAcademicInfo', 'class' => 'position-relative');
						...
						<div class="form-field-content">
							<table class="table" style="width:100%">
								...
								<tr>
									...
									<td><a href="<?php echo base_url('attachments/faculties/'.$academic['teacher_entryid'].'/'.$academic['tacinfo_certificate']); ?>" target="_blank">View Certificate</a></td>
									<td><strong class="remove-ace" data-id="<?php echo $academic['tacinfo_id']; ?>" style="color:#A00;cursor:pointer">Delete</strong></td>
								</tr>
								<?php 
									endforeach;
									else:
		...
		$(document).ready(function(){
			$(document).on('click', '.remove-ace', function(){
				if(confirm('Are you sure?', true))
				{
					...
					$.ajax({
						type : "POST",
						url : baseUrl + "faculty/delete_academic_info",
						data : {id:data_id},
						dataType : "json",
			...
			//start step 2
			$("#updateTeacherAcademicInfo").validate({
				rules:{
					degree:{
						required: true,
					},year:{
				...
				submitHandler : function () {
					$('#proccessLoader').show();
					var personalFormData = new FormData(document.getElementById('updateTeacherAcademicInfo'));    
					$.ajax({
						type : "POST",
						url : baseUrl + "faculty/update_academic_info",
