...
class Discussion_model extends CI_Model {
	...
	public function get_students_by_search($q)
	{
		$query = $this->db->query("SELECT * FROM starter_students
								   LEFT JOIN starter_students_personalinfo ON
								   starter_students_personalinfo.spinfo_student_id=starter_students.student_id
								   
								   WHERE (starter_students_personalinfo.spinfo_first_name LIKE '%$q%' 
										OR starter_students_personalinfo.spinfo_middle_name LIKE '%$q%' 
										OR starter_students_personalinfo.spinfo_last_name LIKE '%$q%')
	...
	public function get_total_messages_by_student($student_id)
	{
	...
	public function get_discussions_by_student($student_id)
	{
